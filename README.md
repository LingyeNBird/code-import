...
| 参数名                                       | 类型  | 必填 | 默认值                             | 说明                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
|-------------------------------------------|-----|----|---------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| PLUGIN_SOURCE_URL                         | 字符串 | 是  | https://e.coding.net            | 源仓库代码托管平台URL                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
...
| PLUGIN_MIGRATE_REBASE                     | 布尔值 | 是  | false                           | 在源和目标都有变更的情况下,且CNB侧仓库对应分支根目录有`.cnb.yml`文件，使用git rebase保证代码同步，CNB侧提交的流水线配置代码不会被覆盖<br/>⚠️如开启该配置，将启用强制推送（PLUGIN_MIGRATE_FORCE_PUSH="true"），并在迁移工具执行的工作目录备份CNB侧代码仓库                                                                                                                                                                                                                                                                                                                             |
